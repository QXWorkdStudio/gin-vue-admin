...
type ExchangePointsOrder struct {
      ...
      ExtInfo  * `json:"extInfo" form:"extInfo" gorm:"column:ext_info;comment:额外信息汇总；;"`  //额外信息汇总； 
      MainChannel  string `json:"mainChannel" form:"mainChannel" gorm:"column:main_channel;comment:主渠道;size:50;"`  //主渠道 
      MerchantId  * `json:"merchantId" form:"merchantId" gorm:"column:merchant_id;comment:商户id;"`  //商户id 
